...
class Address(models.Model):
    user = models.userinfo(unique=True, verbose_name='用户')
    address = models.CharField(max_length=100, verbose_name='详细地址')
    status = models.CharField(
        max_length=1, verbose_name='地址状态')
...
class Delivery(models.Model):
    order = models.order(unique=True, verbose_name='订单')
    user = models.userinfo(unique = , verbose_name='密码')
    gender = models.CharField(
        max_length=30, verbose_name='性别')
    phonenumber = models.CharField(
        max_length=30, unique=True, verbose_name='手机号')
