...
|❗ |[5000](#5000)|查询订单信息|api/order/info|GET|{order_id}||
|❗ |[5001](#5001)|创建订单|api/order/append|POST|{*}||
|❌ |[5002](#5002)|*修改订单地址*|api/order/seeting/address|POST|{order_id, address}|低优先级|
|❗ |[5011](#5011)|确认收货|api/order/finish|POST|{order_id}||
|  |[5012](#5012)||||||
...
---
#### <font id="5000" color="#004085">5000 查询订单信息</font>
~~~
url: "api/order/info",
method: "GET",
data: {
...
---
#### <font id="5001" color="#004085">5001 创建订单</font>
~~~
...
---
#### <font id="5002" color="#004085">5002 修改订单地址</font>
~~~
...
---
#### <font id="5011" color="#004085">5011 确认收货</font>
~~~
